...
export default ({item, accessibilityState, onPress}) => {
    ...
    return(
        ...
        >
            ...
            >
                <Animated.View style={[{width: 50, height: 50, borderRadius: 100, position: 'absolute', backgroundColor: '#53b175'}, scaleStyles]}/>
                <Material name={item.icon} color={accessibilityState.selected ? '#fff' : '#53b175'} size={25}/>
            </Animated.View>
